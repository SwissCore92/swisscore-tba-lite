...
class Bot(BaseBot):
    """
    Telegram Bot API methods scraped from '**Bot API 9.2** *(August 15, 2025)*'
    """
    @api_method_wrapper()
    def get_updates(
        self,
    ...
    def send_message(
        ...
        *,
        ...
        reply_markup: tg.ReplyKeyboardMarkup | tg.InlineKeyboardMarkup | tg.ForceReply | tg.ReplyKeyboardRemove | None = None
    ) -> Task[tg.Message]:
        """
    ...
    @api_method_wrapper(check_input_media={"media": ["cover", "thumbnail", "media"]})
    def send_paid_media(
        self,
        chat_id: int | str,
        star_count: int,
    ...
    @api_method_wrapper(check_input_media={"content": ["photo", "video"]})
    def post_story(
        self,
        business_connection_id: str,
