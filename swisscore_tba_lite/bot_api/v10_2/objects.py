"""
Telegram types scraped from 'Bot API 10.2 (July 14, 2026)'
"""
...
class Update(t.TypedDict):
    ...
    guest_message: t.NotRequired["Message"]
    ...
    managed_bot: t.NotRequired["ManagedBotUpdated"]
    subscription: t.NotRequired["BotSubscriptionUpdated"]
...
class User(t.TypedDict):
    ...
    supports_guest_queries: t.NotRequired[bool]
    supports_inline_queries: t.NotRequired[bool]
    can_connect_to_business: t.NotRequired[bool]
    has_main_web_app: t.NotRequired[bool]
    has_topics_enabled: t.NotRequired[bool]
    allows_users_to_create_topics: t.NotRequired[bool]
    can_manage_bots: t.NotRequired[bool]
    supports_join_request_queries: t.NotRequired[bool]
...
class ChatFullInfo(t.TypedDict):
    ...
    rating: t.NotRequired["UserRating"]
    first_profile_audio: t.NotRequired["Audio"]
    unique_gift_colors: t.NotRequired["UniqueGiftColors"]
    paid_message_star_count: t.NotRequired[int]
    guard_bot: t.NotRequired["User"]
    community: t.NotRequired["Community"]
...
class Message(t.TypedDict("Message", {"from": "User"})):
    ...
    sender_tag: t.NotRequired[str]
    receiver_user: t.NotRequired["User"]
    ephemeral_message_id: t.NotRequired[int]
    guest_query_id: t.NotRequired[str]
    ...
    reply_to_poll_option_id: t.NotRequired[str]
    via_bot: t.NotRequired["User"]
    guest_bot_caller_user: t.NotRequired["User"]
    guest_bot_caller_chat: t.NotRequired["Chat"]
    ...
    chat_owner_left: t.NotRequired["ChatOwnerLeft"]
    chat_owner_changed: t.NotRequired["ChatOwnerChanged"]
    ...
    gift_upgrade_sent: t.NotRequired["GiftInfo"]
    ...
    community_chat_added: t.NotRequired["CommunityChatAdded"]
    community_chat_removed: t.NotRequired["CommunityChatRemoved"]
    ...
    managed_bot_created: t.NotRequired["ManagedBotCreated"]
    paid_message_price_changed: t.NotRequired["PaidMessagePriceChanged"]
    poll_option_added: t.NotRequired["PollOptionAdded"]
    poll_option_deleted: t.NotRequired["PollOptionDeleted"]
...
class MessageEntity(t.TypedDict):
    ...
    unix_time: t.NotRequired[int]
    date_time_format: t.NotRequired[str]
...
class ReplyParameters(t.TypedDict):
    ...
    poll_option_id: t.NotRequired[str]
...
class VideoQuality(t.TypedDict):
    """
...
class Video(t.TypedDict):
    ...
    qualities: t.NotRequired[list["VideoQuality"]]
    file_name: t.NotRequired[str]
    mime_type: t.NotRequired[str]
    file_size: t.NotRequired[int]
...
class PaidMediaLivePhoto(t.TypedDict):
    """
...
class PollOption(t.TypedDict):
    ...
    media: t.NotRequired["PollMedia"]
    added_by_user: t.NotRequired["User"]
    added_by_chat: t.NotRequired["Chat"]
    addition_date: t.NotRequired[int]
...
class InputPollOption(t.TypedDict):
    ...
    text_entities: t.NotRequired[list["MessageEntity"]]
    media: t.NotRequired["InputPollOptionMedia"]
...
class ChecklistTask(t.TypedDict):
    ...
    completed_by_chat: t.NotRequired["Chat"]
...
class ManagedBotCreated(t.TypedDict):
    """
...
class ManagedBotUpdated(t.TypedDict):
    """
...
class BotSubscriptionUpdated(t.TypedDict):
    """
...
class PollOptionAdded(t.TypedDict):
    """
    ...
    option_text: str
    poll_message: t.NotRequired["MaybeInaccessibleMessage"]
    option_text_entities: t.NotRequired[list["MessageEntity"]]

class PollOptionDeleted(t.TypedDict):
    """
...
class CommunityChatAdded(t.TypedDict):
    """
...
class CommunityChatRemoved(t.TypedDict):
    """
...
class ForumTopicCreated(t.TypedDict):
    ...
    is_name_implicit: t.NotRequired[t.Literal[True]]
...
class UserProfileAudios(t.TypedDict):
    """
...
class KeyboardButtonRequestManagedBot(t.TypedDict):
    """
    ...
    """
    request_id: int
    suggested_name: t.NotRequired[str]
    suggested_username: t.NotRequired[str]
...
class ChatAdministratorRights(t.TypedDict):
    ...
    can_manage_tags: t.NotRequired[bool]
...
class ChatPermissions(t.TypedDict):
    ...
    can_react_to_messages: t.NotRequired[bool]
    can_edit_tag: t.NotRequired[bool]
...
class UserRating(t.TypedDict):
    ...
    next_level_rating: t.NotRequired[int]
...
class GiftBackground(t.TypedDict):
    """
...
class Gift(t.TypedDict):
    ...
    is_premium: t.NotRequired[t.Literal[True]]
    has_colors: t.NotRequired[t.Literal[True]]
    total_count: t.NotRequired[int]
    remaining_count: t.NotRequired[int]
    personal_total_count: t.NotRequired[int]
    personal_remaining_count: t.NotRequired[int]
    background: t.NotRequired["GiftBackground"]
    unique_gift_variant_count: t.NotRequired[int]
...
class UniqueGiftColors(t.TypedDict):
    """
...
class UniqueGift(t.TypedDict):
    ...
    is_premium: t.NotRequired[t.Literal[True]]
    is_burned: t.NotRequired[t.Literal[True]]
    is_from_blockchain: t.NotRequired[t.Literal[True]]
    colors: t.NotRequired["UniqueGiftColors"]
    publisher_chat: t.NotRequired["Chat"]
...
class GiftInfo(t.TypedDict):
    ...
    is_upgrade_separate: t.NotRequired[t.Literal[True]]
    can_be_upgraded: t.NotRequired[t.Literal[True]]
    text: t.NotRequired[str]
    entities: t.NotRequired[list["MessageEntity"]]
    is_private: t.NotRequired[t.Literal[True]]
    unique_gift_number: t.NotRequired[int]
...
class UniqueGiftInfo(t.TypedDict):
    ...
    gift: "UniqueGift"
    origin: str
    last_resale_currency: t.NotRequired[str]
    last_resale_amount: t.NotRequired[int]
    owned_gift_id: t.NotRequired[str]
...
class BotAccessSettings(t.TypedDict):
    """
    ...
    added_users: t.NotRequired[list["User"]]
...
class BotCommand(t.TypedDict):
    ...
    command: str
    description: str
    is_ephemeral: t.NotRequired[bool]
...
class ChatOwnerLeft(t.TypedDict):
    """
    ### [ChatOwnerLeft](https://core.telegram.org/bots/api#chatownerleft)  
    
    Describes a service message about the chat owner leaving the chat.
    """
    new_owner: t.NotRequired["User"]

class ChatOwnerChanged(t.TypedDict):
    """
...
class SentGuestMessage(t.TypedDict):
    """
...
class PreparedKeyboardButton(t.TypedDict):
    """
...
class InputMediaLink(t.TypedDict):
    """
...
class InputMediaLivePhoto(t.TypedDict):
    """
...
class InputMediaLocation(t.TypedDict):
    """
...
class InputMediaSticker(t.TypedDict):
    """
...
class InputMediaVenue(t.TypedDict):
    """
...
class InputMediaVoiceNote(t.TypedDict):
    """
...
class InputPaidMediaLivePhoto(t.TypedDict):
    """
...
class RichMessage(t.TypedDict):
    ...
    is_rtl: t.NotRequired[bool]

class InputRichMessage(t.TypedDict):
    """
    ### [InputRichMessage](https://core.telegram.org/bots/api#inputrichmessage)  
    
    Describes a rich message to be sent. Exactly **one** of the fields *html*, *markdown*, or *blocks* must be used.
    """
    blocks: t.NotRequired[list["InputRichBlock"]]
    html: t.NotRequired[str]
    markdown: t.NotRequired[str]
    media: t.NotRequired[list["InputRichMessageMedia"]]
    is_rtl: t.NotRequired[bool]
    skip_entity_detection: t.NotRequired[bool]

class InputRichMessageMedia(t.TypedDict):
    """
    ...
    """
    id: str
    media: "InputMediaVoiceNote" | "InputMediaPhoto" | "InputMediaVideo" | "InputMediaAudio" | "InputMediaAnimation"

class RichTextBold(t.TypedDict):
    """
...
class RichTextCustomEmoji(t.TypedDict):
    """
...
class RichTextMathematicalExpression(t.TypedDict):
    """
    ### [RichTextMathematicalExpression](https://core.telegram.org/bots/api#richtextmathematicalexpression)  
    
    A mathematical expression.
    """
    type: t.Literal["mathematical_expression"]
    expression: str

class RichTextUrl(t.TypedDict):
    """
...
class RichTextEmailAddress(t.TypedDict):
    """
    ### [RichTextEmailAddress](https://core.telegram.org/bots/api#richtextemailaddress)  
    
    A text with an email address.
    """
    type: t.Literal["email_address"]
    text: "RichText"
    email_address: str

class RichTextPhoneNumber(t.TypedDict):
    """
...
class RichTextBankCardNumber(t.TypedDict):
    """
    ### [RichTextBankCardNumber](https://core.telegram.org/bots/api#richtextbankcardnumber)  
    
    A text with a bank card number.
    """
    type: t.Literal["bank_card_number"]
    text: "RichText"
    bank_card_number: str

class RichTextMention(t.TypedDict):
    """
...
class RichTextHashtag(t.TypedDict):
    """
...
class RichTextCashtag(t.TypedDict):
    """
    ### [RichTextCashtag](https://core.telegram.org/bots/api#richtextcashtag)  
    
    A cashtag.
    """
    type: t.Literal["cashtag"]
    text: "RichText"
    cashtag: str

class RichTextBotCommand(t.TypedDict):
    """
    ### [RichTextBotCommand](https://core.telegram.org/bots/api#richtextbotcommand)  
    
    A bot command.
    """
    type: t.Literal["bot_command"]
    text: "RichText"
    bot_command: str

class RichTextAnchor(t.TypedDict):
    """
    ### [RichTextAnchor](https://core.telegram.org/bots/api#richtextanchor)  
    
    An anchor.
    """
    type: t.Literal["anchor"]
    name: str

class RichTextAnchorLink(t.TypedDict):
    """
    ### [RichTextAnchorLink](https://core.telegram.org/bots/api#richtextanchorlink)  
    
    A link to an anchor.
    """
    type: t.Literal["anchor_link"]
    text: "RichText"
    anchor_name: str

class RichTextReference(t.TypedDict):
    """
...
class RichTextReferenceLink(t.TypedDict):
    """
    ### [RichTextReferenceLink](https://core.telegram.org/bots/api#richtextreferencelink)  
    
    A link to a reference.
    """
    type: t.Literal["reference_link"]
    text: "RichText"
    reference_name: str

class RichBlockCaption(t.TypedDict):
    """
    ...
    """
    text: "RichText"
    credit: t.NotRequired["RichText"]

class RichBlockTableCell(t.TypedDict):
    """
    ...
    align: str
    valign: str
    text: t.NotRequired["RichText"]
    is_header: t.NotRequired[t.Literal[True]]
    colspan: t.NotRequired[int]
    rowspan: t.NotRequired[int]

class RichBlockListItem(t.TypedDict):
    """
    ...
    label: str
    blocks: list["RichBlock"]
    has_checkbox: t.NotRequired[t.Literal[True]]
    is_checked: t.NotRequired[t.Literal[True]]
    value: t.NotRequired[int]
    type: t.NotRequired[str]

class RichBlockParagraph(t.TypedDict):
    """
...
class RichBlockSectionHeading(t.TypedDict):
    """
...
class RichBlockPreformatted(t.TypedDict):
    """
...
class RichBlockFooter(t.TypedDict):
    """
    ### [RichBlockFooter](https://core.telegram.org/bots/api#richblockfooter)  
    
    A footer, corresponding to the HTML tag `<footer>`.
    """
    type: t.Literal["footer"]
    text: "RichText"

class RichBlockDivider(t.TypedDict):
    """
    ### [RichBlockDivider](https://core.telegram.org/bots/api#richblockdivider)  
    
    A divider, corresponding to the HTML tag `<hr/>`.
    """
    type: t.Literal["divider"]

class RichBlockMathematicalExpression(t.TypedDict):
    """
...
class RichBlockAnchor(t.TypedDict):
    """
...
class RichBlockList(t.TypedDict):
    """
...
class RichBlockBlockQuotation(t.TypedDict):
    """
...
class RichBlockTable(t.TypedDict):
    ...
    is_bordered: t.NotRequired[t.Literal[True]]
    is_striped: t.NotRequired[t.Literal[True]]
    caption: t.NotRequired["RichText"]

class RichBlockDetails(t.TypedDict):
    """
    ### [RichBlockDetails](https://core.telegram.org/bots/api#richblockdetails)  
    
    An expandable block for details disclosure, corresponding to the HTML tag `<details>`.
    """
    type: t.Literal["details"]
    summary: "RichText"
    blocks: list["RichBlock"]
    is_open: t.NotRequired[t.Literal[True]]

class RichBlockMap(t.TypedDict):
    """
...
class RichBlockAnimation(t.TypedDict):
    """
    ...
    type: t.Literal["animation"]
    animation: "Animation"
    has_spoiler: t.NotRequired[t.Literal[True]]
    caption: t.NotRequired["RichBlockCaption"]

class RichBlockAudio(t.TypedDict):
    """
...
class RichBlockPhoto(t.TypedDict):
    """
...
class RichBlockVideo(t.TypedDict):
    """
...
class RichBlockVoiceNote(t.TypedDict):
    """
    ### [RichBlockVoiceNote](https://core.telegram.org/bots/api#richblockvoicenote)  
    
    A block with a voice note, corresponding to the HTML tag `<audio>`.
    """
    type: t.Literal["voice_note"]
    voice_note: "Voice"
    caption: t.NotRequired["RichBlockCaption"]

class RichBlockThinking(t.TypedDict):
    """
...
class InputRichBlockListItem(t.TypedDict):
    """
...
class InputRichBlockParagraph(t.TypedDict):
    """
...
class InputRichBlockSectionHeading(t.TypedDict):
    """
...
class InputRichBlockPreformatted(t.TypedDict):
    """
...
class InputRichBlockFooter(t.TypedDict):
    """
...
class InputRichBlockDivider(t.TypedDict):
    """
...
class InputRichBlockMathematicalExpression(t.TypedDict):
    """
...
class InputRichBlockAnchor(t.TypedDict):
    """
...
class InputRichBlockList(t.TypedDict):
    """
...
class InputRichBlockBlockQuotation(t.TypedDict):
    """
...
class InputRichBlockPullQuotation(t.TypedDict):
    """
...
class InputRichBlockCollage(t.TypedDict):
    """
...
class InputRichBlockSlideshow(t.TypedDict):
    """
...
class InputRichBlockTable(t.TypedDict):
    """
...
class InputRichBlockDetails(t.TypedDict):
    """
...
class InputRichBlockMap(t.TypedDict):
    """
...
class InputRichBlockAnimation(t.TypedDict):
    """
...
class InputRichBlockAudio(t.TypedDict):
    """
...
class InputRichBlockPhoto(t.TypedDict):
    """
...
class InputRichBlockVideo(t.TypedDict):
    """
...
class InputRichBlockVoiceNote(t.TypedDict):
    """
...
class InputRichBlockThinking(t.TypedDict):
    """
...
class InputRichMessageContent(t.TypedDict):
    """
...
class PaidMedia(PaidMediaLivePhoto, PaidMediaPhoto, PaidMediaPreview, PaidMediaVideo):
    """
    ...
    * [PaidMediaVideo](https://core.telegram.org/bots/api#paidmediavideo)
    """
    type: t.Literal["live_photo", "photo", "preview", "video"]

class InputPollMedia(InputMediaAnimation, InputMediaAudio, InputMediaDocument, InputMediaLivePhoto, InputMediaLocation, InputMediaPhoto, InputMediaVenue, InputMediaVideo):
    """
    ...
    * [InputMediaVideo](https://core.telegram.org/bots/api#inputmediavideo)
    """
    type: t.Literal["animation", "audio", "document", "live_photo", "location", "photo", "venue", "video"]

class InputPollOptionMedia(InputMediaAnimation, InputMediaLink, InputMediaLivePhoto, InputMediaLocation, InputMediaPhoto, InputMediaSticker, InputMediaVenue, InputMediaVideo):
    """
    ...
    * [InputMediaVideo](https://core.telegram.org/bots/api#inputmediavideo)
    """
    type: t.Literal["animation", "link", "live_photo", "location", "photo", "sticker", "venue", "video"]
...
class InputMedia(InputMediaAnimation, InputMediaAudio, InputMediaDocument, InputMediaLivePhoto, InputMediaPhoto, InputMediaVideo):
    """
    ...
    * [InputMediaVideo](https://core.telegram.org/bots/api#inputmediavideo)
    """
    type: t.Literal["animation", "audio", "document", "live_photo", "photo", "video"]

class InputPaidMedia(InputPaidMediaLivePhoto, InputPaidMediaPhoto, InputPaidMediaVideo):
    """
    ...
    * [InputPaidMediaVideo](https://core.telegram.org/bots/api#inputpaidmediavideo)
    """
    type: t.Literal["live_photo", "photo", "video"]
...
class RichText(RichTextBold, RichTextItalic, RichTextUnderline, RichTextStrikethrough, RichTextSpoiler, RichTextDateTime, RichTextTextMention, RichTextSubscript, RichTextSuperscript, RichTextMarked, RichTextCode, RichTextCustomEmoji, RichTextMathematicalExpression, RichTextUrl, RichTextEmailAddress, RichTextPhoneNumber, RichTextBankCardNumber, RichTextMention, RichTextHashtag, RichTextCashtag, RichTextBotCommand, RichTextAnchor, RichTextAnchorLink, RichTextReference, RichTextReferenceLink):
    ...
    * [RichTextReferenceLink](https://core.telegram.org/bots/api#richtextreferencelink)
    """
    type: t.Literal["bold", "italic", "underline", "strikethrough", "spoiler", "date_time", "text_mention", "subscript", "superscript", "marked", "code", "custom_emoji", "mathematical_expression", "url", "email_address", "phone_number", "bank_card_number", "mention", "hashtag", "cashtag", "bot_command", "anchor", "anchor_link", "reference", "reference_link"]

class RichBlock(RichBlockParagraph, RichBlockSectionHeading, RichBlockPreformatted, RichBlockFooter, RichBlockDivider, RichBlockMathematicalExpression, RichBlockAnchor, RichBlockList, RichBlockBlockQuotation, RichBlockPullQuotation, RichBlockCollage, RichBlockSlideshow, RichBlockTable, RichBlockDetails, RichBlockMap, RichBlockAnimation, RichBlockAudio, RichBlockPhoto, RichBlockVideo, RichBlockVoiceNote, RichBlockThinking):
    """
    ...
    * [RichBlockThinking](https://core.telegram.org/bots/api#richblockthinking)
    """
    type: t.Literal["paragraph", "heading", "pre", "footer", "divider", "mathematical_expression", "anchor", "list", "blockquote", "pullquote", "collage", "slideshow", "table", "details", "map", "animation", "audio", "photo", "video", "voice_note", "thinking"]

class InputRichBlock(InputRichBlockParagraph, InputRichBlockSectionHeading, InputRichBlockPreformatted, InputRichBlockFooter, InputRichBlockDivider, InputRichBlockMathematicalExpression, InputRichBlockAnchor, InputRichBlockList, InputRichBlockBlockQuotation, InputRichBlockPullQuotation, InputRichBlockCollage, InputRichBlockSlideshow, InputRichBlockTable, InputRichBlockDetails, InputRichBlockMap, InputRichBlockAnimation, InputRichBlockAudio, InputRichBlockPhoto, InputRichBlockVideo, InputRichBlockVoiceNote, InputRichBlockThinking):
    """
...
class InputMessageContent(InputTextMessageContent, InputRichMessageContent, InputLocationMessageContent, InputVenueMessageContent, InputContactMessageContent, InputInvoiceMessageContent):
    """
